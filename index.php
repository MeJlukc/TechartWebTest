...
<body>
    ...
    <main>
        <section class="last-news">
            <h1 class="last-news-title">Возвращение этнографа</h1>
            <p class="last-news-text">Сегодня с Проксимы вернулась этнографическая экспедиция Джона Голдрама.</p>
        </section>
        <section class="news">
            ...
            <ul class="pagination-group-list">
                ...
                <li class="pagination-item">
                    <a href="/" class="pagination-button-link">1</a>
                </li>
                <li class="pagination-item">
                    <a href="/" class="pagination-button-link">2</a>
                </li>
                <li class="pagination-item">
